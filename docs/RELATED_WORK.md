...
This note situates **Stress-Testing Emergent-Misalignment Model Organisms** against the motivating literature for
[Stress-Testing Emergent-Misalignment Model Organisms](https://github.com/alanasung/em-organism-redteam).

## Positioning

Red-team RL-trained emergent-misalignment organisms and measure which failure modes survive simple probes.

The design hypothesis is: Red-team RL-trained emergent-misalignment organisms and measure which failure modes survive simple probes.
