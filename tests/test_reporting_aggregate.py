import json
from emred.reporting.aggregate import aggregate_results, flatten_metrics
from emred.reporting.tables import write_tables
from emred.reporting.figures import write_caption, write_figures
