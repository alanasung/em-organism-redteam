import numpy as np
from emred.ablation.controls import run_control_arms
from emred.ablation.component_dropout import run_component_dropout
from emred.ablation.seed_sweep import run_seed_sweep
