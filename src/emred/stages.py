"""Experiment stages for Stress-Testing Emergent-Misalignment Model Organisms."""
...
from .emred._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Stress-Testing Emergent-Misalignment Model Organisms", "claims_gated": True},
    )
