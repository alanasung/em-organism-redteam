...
from emred.configs.loader import register_schema
...
def _load_stage_registry(package: str = "emred") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in emred.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from emred.configs.loader import config_to_dict, save_resolved_config
    from emred.models.device import get_device
    from emred.utils.logging import configure_logging
    from emred.utils.reproducibility import set_seed
    from emred.utils.run_manifest import create_run_dir, save_run_metadata
